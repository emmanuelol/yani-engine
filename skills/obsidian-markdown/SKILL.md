...
description: Passes the command directly to the yani-engine Python orchestrator for execution.
---
...
> `bash ~/.gemini/config/plugins/yani-engine/run_yani.sh obsidian-markdown "[user's exact raw prompt if provided]"`
